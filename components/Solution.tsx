...
const layers = [
  {
    ...
    desc: "Estabiliza la producción. Evita sobrecostos y retrabajos.",
  ...
  },
  {
    ...
    desc: "Optimiza proyectos de inicio a fin. Aumenta la rentabilidad.",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? "24px" : "40px" }}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? "24px" : "48px", alignItems: "start" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? "16px" : "24px" }}>
              ...
              <FadeIn delay={200}>
                <p style={{ fontSize: isMobile ? "16px" : "20px", color: "#F8F7F4", lineHeight: 1.8 }}>
              ...
              <div className="layer-row">
                <div style={{ display: "flex", minHeight: isMobile ? "auto" : "120px" }}>
                  ...
                  <div style={{ flex: 1, padding: isMobile ? "16px" : "28px 32px" }}>
                    ...
                    <p style={{ fontSize: isMobile ? "14px" : "17px", color: "#CCCCCC", lineHeight: 1.6, fontWeight: 500 }}>{layer.desc}</p>
                  </div>
                </div>
