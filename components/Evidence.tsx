...
const WHATSAPP_NUMBER = "51944071911"; // <-- reemplaza por tu número real (código de país + número, sin +)
...
export default function Evidence() {
  ...
  const handleRequest = async () => {
    ...
    const mensaje = `Hola, quisiera recibir el caso de estudio de Quellaveco (Torre de Captacion 04). Soy ${leadForm.nombre} de ${leadForm.empresa}.`;
        ...
        <div style={{ background: "#EEECEA", border: "0.5px solid #C8C6C0", borderRadius: "12px", padding: isMobile ? "16px" : "28px", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 0.6fr", gap: isMobile ? "16px" : "28px", maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ background: "#F8F7F4", border: "0.5px solid #C8C6C0", borderRadius: "8px", overflow: "hidden", display: "flex", flexDirection: "column" }}>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", flex: 1 }}>
              <div style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <h3 style={{ fontSize: isMobile ? "17px" : "21px", fontWeight: 800, color: "#0A0A0A", lineHeight: 1.2, margin: 0 }}>
                  Diseno y optimizacion de un sistema de produccion complejo
                </h3>
                <p style={{ fontSize: "13px", color: "#888888", lineHeight: 1.6, margin: 0, letterSpacing: "0.05em" }}>
                  Torre de Captacion 04 · Obra civil · Quellaveco
                </p>
                <p style={{ fontSize: "17px", color: "#666666", lineHeight: 1.8, margin: 0 }}>
                  Sistema implementado para reducir variabilidad y optimizar el flujo de produccion.
                </p>
              </div>
              <div style={{ position: "relative", background: "#111827", minHeight: isMobile ? "200px" : "320px" }}>
                <Image src="/quellaveco1.jpg" alt="Optimizacion sistema de produccion Torre de Captacion Quellaveco COSAPI" fill sizes={isMobile ? "100vw" : "25vw"} style={{ objectFit: "cover", objectPosition: "center" }} />
              </div>
            </div>
            {/* Metricas */}
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", background: "#0A0A0A", borderTop: "0.5px solid #2A2A2A" }}>
              {[
                ...
                { val: "9 dias", label: "Optimizacion de plazo" },
                { val: "15%", label: "Reduccion ciclo TG 18.8 -> 16 min/mov" },
              ].map((m, i) => (
          ...
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              ...
              <p style={{ fontSize: "13px", color: "#888888", letterSpacing: "0.05em", marginBottom: "8px" }}>Certificacion Diseno y Construccion Virtual (VDC) 2026</p>
              <h3 style={{ fontSize: isMobile ? "18px" : "22px", fontWeight: 800, color: "#0A0A0A", lineHeight: 1.2, margin: "0 0 8px 0" }}>
                Gestion de Produccion de Proyectos (PPM)
              </h3>
              <p style={{ fontSize: "15px", color: "#888888", lineHeight: 1.6, margin: "0 0 20px 0" }}>Presentacion en Semana Introductoria</p>
              ...
              <p style={{ fontSize: "17px", color: "#666666", lineHeight: 1.8 }}>
                Caso de estudio presentado en la certificacion VDC 2026. Analisis de variabilidad operativa en proyecto de infraestructura minera, con metodologia PPM aplicada en campo.
              </p>
            </div>
          ...
          <div style={{ background: "#EEECEA", borderRadius: "12px", padding: "40px", maxWidth: "420px", width: "90%", position: "relative" }}>
            ...
            {!leadSubmitted ? (
              <>
                ...
                <h3 style={{ fontSize: "22px", fontWeight: 800, color: "#0A0A0A", marginBottom: "8px", lineHeight: 1.2 }}>Solicita la presentacion</h3>
                <p style={{ fontSize: "13px", color: "#666", lineHeight: 1.7, marginBottom: "28px" }}>Te contactaremos por WhatsApp con el caso Quellaveco - Torre de Captacion 04.</p>
              ...
              <div style={{ textAlign: "center", padding: "20px 0" }}>
                ...
                <p style={{ fontSize: "13px", color: "#666" }}>Se abrira una nueva pestana para enviar tu solicitud.</p>
              </div>
            )}
          </div>
        </div>
